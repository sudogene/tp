...
public class MainWindow extends UiPart<Stage> {
    ...
    private TrainingListPanel trainingListPanel;
    ...
    @FXML
    private StackPane trainingListPanelPlaceholder;
    ...
    void fillInnerParts() {
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getCanoeCoachFilePath());
     ...
     *
     * @see seedu.canoe.logic.Logic#execute(String)
     */
