...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() throws ParseException {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
            ...
            + THURSDAY_DESC_BOB + FRIDAY_DESC_BOB + ID_DESC_AMY, new AddCommand(expectedStudent));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ACADEMICYEAR_DESC_BOB
            ...
            + THURSDAY_DESC_BOB + FRIDAY_DESC_BOB + ID_DESC_AMY, new AddCommand(expectedStudentMultipleTags));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY
                        + EMAIL_DESC_AMY + ACADEMICYEAR_DESC_AMY + ID_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + ACADEMICYEAR_DESC_BOB + ID_DESC_AMY,
                expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                        + VALID_EMAIL_BOB + ACADEMICYEAR_DESC_BOB + ID_DESC_AMY,
                expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ID_DESC_AMY
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + ACADEMICYEAR_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ID_DESC_AMY
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + ACADEMICYEAR_DESC_BOB, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ID_DESC_AMY
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + ACADEMICYEAR_DESC_BOB, Email.MESSAGE_CONSTRAINTS);

        // invalid academic year
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ID_DESC_AMY
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + ID_DESC_AMY
                        + EMAIL_DESC_BOB + ACADEMICYEAR_DESC_BOB,
                Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + ID_DESC_AMY
