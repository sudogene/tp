...
public class CommandTestUtil {
    ...
    public static final List<Id> VALID_ID_LIST_4 = List.of(new Id("1"), new Id("2"));
    public static final List<Id> VALID_ID_LIST_5 = List.of(new Id("4"));
    public static final List<Id> VALID_ID_LIST_6 = List.of(new Id("1"), new Id("2"), new Id("3"));
    public static final List<Id> INVALID_ID_LIST = List.of(new Id("9"));
    public static final List<Id> INVALID_ID_LIST_REPEATED = List.of(new Id("1"), new Id("2"), new Id("2"));
